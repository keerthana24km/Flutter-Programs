...
class _listState extends State<list> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
          children: <Widget>[
            Text("Related Videos",style: TextStyle(fontSize: 30.0,fontWeight: FontWeight.bold)),
            ...
            ElevatedButton(onPressed: () async {
              ...
              if(await canLaunch("$url")){
                ...
                child: Text("Kiska Hain Ye Tumko Intezaar Main Hoon Na 4K Video")),
            SizedBox(height: 15.0),
            ElevatedButton(onPressed: () async {
            ...
            ElevatedButton(onPressed: () async {
              ...
              if(await canLaunch("$url")){
                ...
                child: Text("Sharukh Khan's Introduction to Class | Main Hoon Na")),
            SizedBox(height: 15.0),
            ElevatedButton(onPressed: () async {
            ...
            ElevatedButton(onPressed: () async {
              ...
              if(await canLaunch("$url")){
                ...
                child: Text("Main Hoon Na New Movie Release | Facts and Reviews")),
          ]
      ),
    );
  }
