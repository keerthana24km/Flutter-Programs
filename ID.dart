...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("ID CARD",style: TextStyle(color: Colors.pink[50]),
        ),
        elevation: 0,
        centerTitle: true,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 25.0,),
            Text("COLLEGE",style: TextStyle(color: Colors.black,fontSize: 20.0,letterSpacing: 1.0),),
            SizedBox(height: 10.0,),
            Text("Jyothy Institute of Technology",
